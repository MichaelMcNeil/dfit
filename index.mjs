 ...
 * @returns Duration
 */
export const duration = (...args) => new Duration(...args);
 ...
 * @returns Distance
 */
export const distance = (...args) => new Distance(...args);
 ...
 * @returns Interval
 */
export const interval = (...args) => new Interval(...args);
 ...
 * @returns Speed
 */
export const speed = (...args) => new Speed(...args);
 ...
 * @returns Pace
 */
export const pace = (...args) => new Pace(...args);
